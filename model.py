...
def solve_model(T,state):
    ...
    dO123 = -O123*0.1+10*(((POA23/5)**3))/(1+((POFAC13/5)**2)+((POA23/5)**3)+((POFAC13/5)**2)*((POA23/5)**3))+10*(((POFAC13/5)**2))/(1+((POFAC13/5)**2)+((POA23/5)**3)+((POFAC13/5)**2)*((POA23/5)**3))
    dO223 = -O223*0.1+10*(((O123/5)**2)*((POFAC22/5)**3))/(1+((O123/5)**2)+((POFAC22/5)**3)+((O123/5)**2)*((POFAC22/5)**3))
    dO323 = -O323*0.1+10*(((POFAC13/5)**2)*((POA23/5)**3))/(1+((POFAC13/5)**2)+((POA23/5)**3)+((POFAC13/5)**2)*((POA23/5)**3))
    ...
    dO133 = -O133*0.1+10*(((POA33/5)**3))/(1+((POFAC23/5)**2)+((POA33/5)**3)+((POFAC23/5)**2)*((POA33/5)**3))+10*(((POFAC23/5)**2))/(1+((POFAC23/5)**2)+((POA33/5)**3)+((POFAC23/5)**2)*((POA33/5)**3))
    dO233 = -O233*0.1+10*(((O133/5)**2)*((POFAC32/5)**3))/(1+((O133/5)**2)+((POFAC32/5)**3)+((O133/5)**2)*((POFAC32/5)**3))
    dO333 = -O333*0.1+10*(((POFAC23/5)**2)*((POA33/5)**3))/(1+((POFAC23/5)**2)+((POA33/5)**3)+((POFAC23/5)**2)*((POA33/5)**3))
